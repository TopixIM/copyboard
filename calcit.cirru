  ...
  :files $ {}
    'app.client $ %{} 'FileEntry
      :defs $ {}
        '*preview-data $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defatom *preview-data ([])
          :examples $ []
          :schema $ :: 'Dynamic
            ...
            try
              let
                  response $ js-await $ js/fetch
                    if config/dev? |http://localhost:11030/ |/apis/query
              ...
              fn (error)
                js/console.warn |Failed-to-load-preview-data error
                reset! *preview-data $ []
          :examples $ []
        ...
        'read-from-clipboard! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn read-from-clipboard! ()
            if
              js-present? js/navigator.clipboard
              let
                ...
                .!catch result $ fn (err)
                  do
                    js/console.warn |Clipboard-read-skipped err
                    , nil
        ...
        'simulate-login! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn simulate-login! ()
            let
                raw $ js/localStorage.getItem $ option:unwrap-or (get config/site :storage-key) |copyboard
              if (js-present? raw)
    ...
    'app.comp.container $ %{} 'FileEntry
      :defs $ {}
        'comp-container $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defcomp comp-container (states store preview-data)
            if (enum? store)
                  ...
                  div
                    ...
                    if logged-in?
                      case-default
                        ...
                        :profile $ comp-profile user $ option:unwrap-or (get router :data) ({})
                      div ({})
                        if (some? preview-data)
            ...
            div
              {}
                ...
                :style $ {} $ :background-color
                  option:unwrap-or (get config/site :theme) |#ECCE32
              div $ {} $ :style
                {} $ :height 0
              div $ {} $ :style
                {}
        ...
        'style-status-buble $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defstyle style-status-buble
    ...
    'app.comp.home $ %{} 'FileEntry
      :defs $ {}
            ...
            let
                ...
                send! $ fn (e d!)
                  do
                    ...
                    , &unit
                confirm-plugin $ use-confirm
                  >> states :clipboard-confirm
                  ...
                  :handler $ fn (event d!)
                    match event $
                      ...
                      when
                        ...
                        .show-with-text confirm-plugin d!
                          str "|Clipboard content detected, would you like to fill it into the input box?\n" text
        ...
        'comp-home $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defcomp comp-home (states snippets show-all? user)
            div
        ...
        'comp-snippet $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defcomp comp-snippet (states k snippet)
            let
        ...
        'copy-to-clipboard $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn copy-to-clipboard (url)
            ...
            let
              ...
              js-await $ js/navigator.clipboard.write $ js-array
                new js/ClipboardItem $ let
                    obj $ js-object
        ...
        'download-image! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn download-image! (url)
            hint-fn $ {} $ :async true
            let
                blob $ js-await $ .!blob
                  js-await $ js/fetch url
        ...
        'home-props $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn home-props (user)
            {}
              :class-name $ str-spaced css/column css/expand
              :style $ {}
                :padding "|12px 16px 240px 16px"
                :overflow :auto
        ...
        'style-grid-list $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defstyle style-grid-list
            {} $ |& $ {} (:display :grid)
        ...
        'style-snippet $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defstyle style-snippet
            {}
              |& $ {} (:margin-bottom 8) (:max-width |100%) (:position :relative)
        ...
        'style-snippet-content $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defstyle style-snippet-content
        ...
        'style-snippet-span $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defstyle style-snippet-span
            {}
              |& $ {} (:opacity 0.5)
                :transition-duration |240ms
              (str |. style-snippet "|:hover &")
    ...
    'app.comp.navigation $ %{} 'FileEntry
      :defs $ {}
        'comp-navigation $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defcomp comp-navigation (states user logged-in? count-members offline?)
            div
              {}
                :class-name $ str-spaced css/row-parted style-nav
                :style $ if offline? $ {} (:opacity 0.1)
              div
                {} (:class-name css/row-middle)
                  :on-click $ fn (e d!)
      ...
      :defs $ {}
        'comp-file-upload $ %{} 'CodeEntry (:doc |)
                ...
                a
                  {} (:class-name css/link)
                    ...
                    :on-click $ fn (e d!)
                      do
                        .!click $ unsafe-coerce
                          js/document.querySelector |#upload-input
                          , JsObject
                        , &unit
                  <> |Upload
                if uploading? $ span
          ...
          :schema $ :: 'Fn $ {} (:return 'Dynamic)
            :args $ [] 'Dynamic 'Dynamic
            :features $ #{} :js-ffi
        'decorate-name $ %{} 'CodeEntry
          :doc "|`paste` event uses default name `image.png` as the file name, need to overwrite that.\n\nalso spaces in filekey causes problems of inline CSS, need to replace that."
            ...
            let
                ...
                res $ js-await $ .!post axios |https://cp.topix.im/token
                  format-cirru-edn $ {}
                    ...
                    :file-key file-key
                  js-object $ :onUploadProgress $ fn (event)
                    let
                        percent $ /
              ...
              d! $ :: :snippet/create-file
                str |https://cos-sh.tiye.me/cos-up/ file-key
                , :file
    ...
    'app.config $ %{} 'FileEntry
      :defs $ {}
        ...
        'site $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def site
            {} (:port 11006) (:http-port 11030) (:title |Copyboard)
      ...
      :defs $ {}
        ...
        'snippet $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def snippet
            {} (:id nil) (:content |) (:time 0) (:author-id nil) (:type :text)
          :examples $ []
          :schema $ :: 'Dynamic
        'user $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def user
            {} (:name nil) (:id nil) (:nickname nil) (:avatar nil) (:password nil) (:token nil)
          :examples $ []
          :schema $ :: 'Dynamic
      :ns $ %{} 'NsEntry (:doc |)
          ...
          :code $ quote $ defn on-request! (req)
            let
                ...
                snippets $ ->
                  ...
                  with-cpu-time
              {} (:code 200)
                :headers $ {} (:content-type |text/cirru-edn)
        ...
        %{} 'CodeEntry (:doc |)
          :code $ quote $ defn updater (db op sid op-id op-time)
            match op
              ...
              (:snippet/create-file url kind)
                snippet/create-file db url kind sid op-id op-time
              (:snippet/remove-one op-data)
                snippet/remove-one db op-data sid op-id op-time
              (:session/show-all op-data)
                session/show-all db op-data sid op-id op-time
